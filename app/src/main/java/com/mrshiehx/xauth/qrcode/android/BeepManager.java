...
/**
 * Manages beeps and vibrations for {@link ScanQRCodeActivity}. 管理声音和震动
 */
public final class BeepManager implements MediaPlayer.OnCompletionListener,
    ...
    private static boolean shouldBeep(SharedPreferences prefs, Context activity) {
        boolean shouldPlayBeep = prefs.getBoolean(
                Preferences.KEY_PLAY_BEEP, true);
        if (shouldPlayBeep) {
	...
	/*private MediaPlayer buildMediaPlayer(Context activity) {
		...
		try {
			...
			com.mrshiehx.mschatroom.overriddens.android.util.XLog.w(TAG, ioe);
			mediaPlayer.release();
			return null;
		}
	}*/
