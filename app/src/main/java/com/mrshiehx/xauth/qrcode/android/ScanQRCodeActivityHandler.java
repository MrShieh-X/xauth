...
package com.mrshiehx.xauth.qrcode.android;
...
import com.mrshiehx.xauth.qrcode.decode.DecodeThread;
import com.mrshiehx.xauth.qrcode.view.ViewfinderResultPointCallback;
 ...
 */
public final class ScanQRCodeActivityHandler extends Handler {
    private static final String TAG = ScanQRCodeActivityHandler.class
            .getSimpleName();
    ...
    public ScanQRCodeActivityHandler(ScanQRCodeActivity activity,
    ...
    public void handleMessage(Message message) {
        ...
        if (what == R.id.restart_preview) {
            ...
            activity.handleDecodeFromCamera((Result) message.obj, barcode, scaleFactor);
