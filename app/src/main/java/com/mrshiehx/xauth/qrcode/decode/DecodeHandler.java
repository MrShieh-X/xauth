...
public final class DecodeHandler extends Handler {
    ...
    private int scannedEightDigitIntegerTime;

    DecodeHandler(ScanQRCodeActivity activity, Map<DecodeHintType, Object> hints) {
    ...
    public void decode(byte[] data, int width, int height) {
        ...
        if (source != null) {
            ...
            try {
				...
				/*try{
					FileUtils.bytes2File(rawResult.getRawBytes(),new File("/sdcard/MSChatRoom/"+System.currentTimeMillis()+","+88+".png"));
				}catch (IOException e){
					e.printStackTrace();
				}*/
        ...
        if (rawResult != null) {
            ...
            if (Utils.isNumber(text) && text.length() == 8) {
                scannedEightDigitIntegerTime++;
                b = scannedEightDigitIntegerTime >= 5;
            }
        }
        if (rawResult != null && b) {
            //("ffff: "+116);
